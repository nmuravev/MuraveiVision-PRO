...
- **Вкладки TopBar** — Медиа / Монтаж / AI-анализ / Обучение / **4×Live** / Система. Вкладки по ширине контента; свободное место справа занимает ряд действий (Экспорт / Раскладка / …). При ширине &lt; ~1100px действия → **«Ещё»**. Статус YOLO/Ollama/роль — в меню аватара. VRAM у аватара.
