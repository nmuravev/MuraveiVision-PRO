...
- **Вкладки TopBar** — Медиа / Монтаж / AI-анализ / Обучение / **4×Live** / Система (смена mosaic-presets + контента). При ширине &lt; ~1400px вторичные (Экспорт / Раскладка / Окна / Гео 3D / Трассировка / Отладка) → меню **«Ещё»**; VRAM и сессия остаются. Статус YOLO/Ollama/роль — в меню аватара сессии (не в полосе). Вкладки: `flex-1` + горизонтальный скролл, подписи с `xl`.
