...
- **Вкладки TopBar** — Медиа / Монтаж / AI-анализ / Обучение / **4×Live** / Система (смена mosaic-presets + контента). При ширине &lt; ~1280px вторичные (Экспорт / Раскладка / Окна / Гео 3D / Трассировка / Отладка) → меню **«Ещё»**; VRAM и сессия остаются.
