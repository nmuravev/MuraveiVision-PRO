...
- **Синие «кубики» на Сцене (2026-09-04):** это sparse COLMAP (`THREE.Points`, раньше квадратные спрайты), **не** фотореализм. Фотореализм — после **Balanced/High** gsplat (`model.ply`). Bootstrap = минимальный splat, тоже не фотореализм.
