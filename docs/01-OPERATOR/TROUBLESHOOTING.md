...
|---------|-----------|----------|---------|
| FPS (YOLOv8n) | 50-200 | < 30 | Проверить GPU |
| FPS (YOLOv8x) | 20-80 | < 10 | Переключиться на n/s модель |
...
| Неподходящая модель | Модель сегментации слишком простая | Использовать YOLOv8-seg m/l |
...
| **Детекция** | YOLOv8n вместо v8x | 3-5x |
...
|--------|-----|-------|-----|-------|
| YOLOv8n | RTX 3060 | 640 | 150 | 0.45 |
| YOLOv8n | RTX 3060 | 1280 | 40 | 0.48 |
| YOLOv8s | RTX 3060 | 640 | 80 | 0.52 |
| YOLOv8m | RTX 3060 | 640 | 35 | 0.58 |
| YOLOv8n | RTX 4090 | 640 | 400 | 0.45 |
| YOLOv8s | RTX 4090 | 640 | 200 | 0.52 |

### Производительность сегментации

| Модель | GPU | imgsz | FPS | mAP50 |
|--------|-----|-------|-----|-------|
| YOLOv8n-seg | RTX 3060 | 640 | 100 | 0.42 |
| YOLOv8s-seg | RTX 3060 | 640 | 55 | 0.50 |
| YOLOv8m-seg | RTX 3060 | 640 | 25 | 0.56 |
